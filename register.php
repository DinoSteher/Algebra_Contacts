		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<form method="post">
					...
					<div class="form-group" class="control-label" <?php echo ($validate->hasError('password')) ? 'has error' : '' ?>>
					...
					<div class="form-group" class="control-label" <?php echo ($validate->hasError('pasword_again')) ? 'has error' : '' ?>>
